...
A goal-tracking growth mentor app where users define a 10-year vision, break it into short/long-term goals across health, soft-skills, and education, and complete a weekly scorecard to measure progress — replacing an expensive personal coach.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "179868378+hkjewel@users.noreply.github.com"
  git config user.name "hkjewel"
  ```
